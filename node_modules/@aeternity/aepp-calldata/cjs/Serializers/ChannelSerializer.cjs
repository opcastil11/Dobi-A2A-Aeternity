...
class ChannelSerializer extends _BaseSerializer.default {
  serialize(data) {
    return [_FateTag.default.OBJECT, _FateTag.default.OTYPE_CHANNEL, ..._rlp.default.encode(data.value)];
  }
  deserializeStream(data) {
    const buffer = new Uint8Array(data);
    const decoded = _rlp.default.decode(buffer.slice(2), true);
    return [new _FateChannelAddress.default(decoded.data), new Uint8Array(decoded.remainder)];
  }
}
var _default = exports.default = ChannelSerializer;