...
var _BytecodeContractCallEncoder = _interopRequireDefault(require("../BytecodeContractCallEncoder.cjs"));
...
class BytecodeContractCallEncoder {
  ...
  */
  constructor(bytecode) {
    this._internalEncoder = new _BytecodeContractCallEncoder.default(bytecode);
  }
